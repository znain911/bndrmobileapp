...
class V11 extends React.Component {
    constructor(props){
        super(props);
      ...
      if (this.state.response[0].patient_gender === '1'){
        ...
        const next = () => {
          ...
          if (this.state.response[0].rowcount === 12) {
            ...
            //this.props.navigation.navigate('V12')
          }
        }
            ...
            <View style ={styles.main}>
                ...
                <ScrollView  >
                    <View style = {styles.infoContainer} >
                        <Text style = {styles.visitNumber}>Visit Number: 11</Text>
...
export default function(props) {
  ...
  return <V11 {...props} navigation={navigation} />;
}