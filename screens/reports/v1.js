   ...
   menu = () => {
    ...
    render() {
      ...
      if (this.state.response[0].patient_gender === '1'){
        ...
        let SenText 
        let AdpPre
        if(newArr[0].footexmprfl_arteria_dorsalis_predis_present_left && newArr[0].footexmprfl_arteria_dorsalis_predis_present_right){
            AdpPre = newArr[0].footexmprfl_arteria_dorsalis_predis_present_left + '|'+ newArr[0].footexmprfl_arteria_dorsalis_predis_present_right
        }else if (newArr[0].footexmprfl_arteria_dorsalis_predis_present_left){
          AdpPre = newArr[0].footexmprfl_arteria_dorsalis_predis_present_left
        }else if (newArr[0].footexmprfl_arteria_dorsalis_predis_present_right){
          AdpPre = newArr[0].footexmprfl_arteria_dorsalis_predis_present_right
        }else {
          AdpPre = null
        }

        let AdpAbs 
        if(newArr[0].footexmprfl_arteria_dorsalis_predis_absent_left && newArr[0].footexmprfl_arteria_dorsalis_predis_absent_right){
            AdpAbs = newArr[0].footexmprfl_arteria_dorsalis_predis_absent_left + '|'+ newArr[0].footexmprfl_arteria_dorsalis_predis_absent_right
        }else if (newArr[0].footexmprfl_arteria_dorsalis_predis_absent_left){
          AdpAbs = newArr[0].footexmprfl_arteria_dorsalis_predis_absent_left
        }else if (newArr[0].footexmprfl_arteria_dorsalis_predis_absent_right){
          AdpAbs = newArr[0].footexmprfl_arteria_dorsalis_predis_absent_right
        }else {
          AdpAbs = null
        }

        let PtPre 
        if(newArr[0].footexmprfl_posterior_tribila_present_left && newArr[0].footexmprfl_posterior_tribila_present_right){
            PtPre = newArr[0].footexmprfl_posterior_tribila_present_left + '|'+ newArr[0].footexmprfl_posterior_tribila_present_right
        }else if (newArr[0].footexmprfl_posterior_tribila_present_left){
          PtPre = newArr[0].footexmprfl_posterior_tribila_present_left
        }else if (newArr[0].footexmprfl_posterior_tribila_present_right){
          PtPre = newArr[0].footexmprfl_posterior_tribila_present_right
        }else {
          PtPre = null
        }

        let PtAbs 
        if(newArr[0].footexmprfl_posterior_tribila_absent_left && newArr[0].footexmprfl_posterior_tribila_absent_right){
            PtAbs = newArr[0].footexmprfl_posterior_tribila_absent_left + '|'+ newArr[0].footexmprfl_posterior_tribila_absent_right
        }else if (newArr[0].footexmprfl_posterior_tribila_absent_left){
          PtAbs = newArr[0].footexmprfl_posterior_tribila_absent_left
        }else if (newArr[0].footexmprfl_posterior_tribila_absent_right){
          PtAbs = newArr[0].footexmprfl_posterior_tribila_absent_right
        }else {
          PtAbs = null
        }

        let MfPre 
        if(newArr[0].footexmsns_monofilament_present_left && newArr[0].footexmsns_monofilament_present_right){
            MfPre = newArr[0].footexmsns_monofilament_present_left + '|'+ newArr[0].footexmsns_monofilament_present_right
        }else if (newArr[0].footexmsns_monofilament_present_left){
          MfPre = newArr[0].footexmsns_monofilament_present_left
        }else if (newArr[0].footexmsns_monofilament_present_right){
          MfPre = newArr[0].footexmsns_monofilament_present_right
        }else {
          MfPre = null
        }
        let MfAbs 
        if(newArr[0].footexmsns_monofilament_absent_left && newArr[0].footexmsns_monofilament_absent_right){
            MfAbs = newArr[0].footexmsns_monofilament_absent_left + '|'+ newArr[0].footexmsns_monofilament_absent_right
        }else if (newArr[0].footexmsns_monofilament_absent_left){
          MfAbs = newArr[0].footexmsns_monofilament_absent_left
        }else if (newArr[0].footexmsns_monofilament_absent_right){
          MfAbs = newArr[0].footexmsns_monofilament_absent_right
        }else {
          MfAbs = null
        }

        let TfPre 
        if(newArr[0].footexmsns_tuning_fork_present_left && newArr[0].footexmsns_tuning_fork_present_right){
            TfPre = newArr[0].footexmsns_tuning_fork_present_left + '|'+ newArr[0].footexmsns_tuning_fork_present_right
        }else if (newArr[0].footexmsns_tuning_fork_present_left){
          TfPre = newArr[0].footexmsns_tuning_fork_present_left
        }else if (newArr[0].footexmsns_tuning_fork_present_right){
          TfPre = newArr[0].footexmsns_tuning_fork_present_right
        }else {
          TfPre = null
        }

        let TfAbs 
        if(newArr[0].footexmsns_tuning_fork_absent_left && newArr[0].footexmsns_tuning_fork_absent_right){
            TfAbs = newArr[0].footexmsns_tuning_fork_absent_left + '|'+ newArr[0].footexmsns_tuning_fork_absent_right
        }else if (newArr[0].footexmsns_tuning_fork_absent_left){
          TfAbs = newArr[0].footexmsns_tuning_fork_absent_left
        }else if (newArr[0].footexmsns_tuning_fork_absent_right){
          TfAbs = newArr[0].footexmsns_tuning_fork_absent_right
        }else {
          TfAbs = null
        }
              ...
              Bangla:this.props.route.params.Bangla
                ...
                <ScrollView  >
                    <View style = {styles.infoContainer} >
                        <Text style = {styles.visitNumber}>Visit Number: 1</Text>
...
export default function(props) {
  ...
  return <V1 {...props} navigation={navigation} />;
}