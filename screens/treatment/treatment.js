...
class TMNT extends React.Component {
    constructor(props){
        super(props);
  ...
  _retrieveData = async () => {
    try {
      const value = await AsyncStorage.getItem('med');
    ...
    render (){
      ...
      //let v1DietNo = newArr.finaltreat_diet_no
      //let v1PageNo = newArr.finaltreat_page_no
      //let v1DAdvice = newArr.finaltreat_dietary_advice
      //let v1PAcitvity = newArr.finaltreat_physical_acitvity
      //let v1Ni = newArr.finaltreat_next_investigation
      //let v1NVD = newArr.finaltreat_next_visit_date
      //let v1Center = newArr.orgcenter_name
      var getdocname = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_doctor_name;
    })
      var getv1DietNo = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_diet_no;
    })
      var getv1PageNo = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_page_no;
    })
      var getv1DAdvice = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_dietary_advice;
    })
      var getv1PAcitvity = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_physical_acitvity;
    })
      var getv1Ni = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_next_investigation;
    })
      var getv1NVD = Object.keys(newArr2).map(function(k) {
        return newArr2[k].finaltreat_next_visit_date;
    })
      var getv1Center = Object.keys(newArr2).map(function(k) {
        return newArr2[k].orgcenter_name;
    })
    var getvisitnum = Object.keys(newArr2).map(function(k) {
      return newArr2[k].visit_number;
    })
    var getvisitDate = Object.keys(newArr2).map(function(k) {
      return newArr[k].visit_date;
    })

    let v1DocName = getdocname[0];
    let v1DietNo = getv1DietNo[0];
    let v1PageNo = getv1PageNo[0];
    let v1DAdvice = getv1DAdvice[0];
    let v1PAcitvity = getv1PAcitvity[0];
    let v1Ni = getv1Ni[0];
    let v1NVD = getv1NVD[0];
    let v1Center = getv1Center[0];
    let visitNum = getvisitnum[0];
    let visitDate = getvisitDate[0];
    //console.log(visitDate);
    //console.log(this.state.response[0].visit_date);
      const Left = () => {
        if (this.state.response[0].rowcount >= 12){

         this.props.navigation.navigate('T11',{
        ...
        if (this.state.response[0].rowcount === 11){
         ...
         this.props.navigation.navigate('T10',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 10){
         ...
         this.props.navigation.navigate('T9',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 9){
         ...
         this.props.navigation.navigate('T8',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 8){
         ...
         this.props.navigation.navigate('T7',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 7){
         ...
         this.props.navigation.navigate('T6',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 6){
         ...
         this.props.navigation.navigate('T5',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
        ...
        if (this.state.response[0].rowcount === 1){
         ...
         alert('No other visit to display');
      ...
      <View style = {styles.visitContainer}>
        <View style = {styles.visitController}>
            ...
            <Entypo name="chevron-left" size={36} color="#2171B5" />
            </TouchableOpacity>
    ...
    <ScrollView >
      <View style = {styles.infoContainer}>
        <Text>Visit number : {visitNum}</Text>
...
export default function(props) {
  ...
  return <TMNT {...props} navigation={navigation} />;
}