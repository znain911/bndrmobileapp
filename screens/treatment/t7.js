...
class T7 extends React.Component {
    ...
    render() {
      ...
      let v1Center = newArr[0].orgcenter_name;
         ...
         const Right = () => {
                if (this.state.response[0][0].rowcount === 8) {
       ...
       // console.log(this.state.response[0][0].rowcount)
        return (
      ...
      <View style = {styles.visitContainer}>
        ...
        <TouchableOpacity 
        onPress={() => {navigation.navigate('TMNT',{
          response: this.props.route.params.response,
          name : this.props.route.params.name,
          patientId : this.props.route.params.patientId,
          bndrId : this.props.route.params.bndrId,
...
export default function(props) {
  ...
  return <T7 {...props} navigation={navigation} />;
}